...
const DEFAULT_SECTIONS: DashboardSection[] = [
  ...
  { id: '6', slug: 'market-comparison', title: 'Your Market Position', description: 'See where you stand against the market', icon: 'lineChart', route: '/market-comparison', status: 'published', sort_order: 1, updated_at: '', updated_by: null },
